...
export class AppService {
  getHello(): string {
    ...
    <div style="font-family: Arial, sans-serif; padding: 20px; max-width: 800px; margin: auto;">
      ...
      <h2 style="margin-top: 20px; color: #34495e;">📘 Documentação da API</h2>
      <p>
        Você pode visualizar todas as rotas e testar os endpoints diretamente no Swagger UI:<br />
        👉 <a href="/api" style="color:#2980b9; text-decoration:none; font-weight:bold;">Acessar documentação Swagger</a>
      </p>
